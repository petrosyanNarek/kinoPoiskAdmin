export const regexp = {
    ...
    password: {
        ...
        message: "The password must be at least 8 characters long, must contain at least one lowercase letter, one uppercase letter, and one digit, and the special characters @$!%*?&"
    }
};
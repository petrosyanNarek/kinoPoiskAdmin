...
import { getGenresById, newGenres, selectGenresLoading, updateGenres } from '../../../features/genresSlice';
...
export const AddAndEditGenres = () => {
    ...
    useEffect(() => {
        if (genreId) {
            dispatch(getGenresById(genreId)).unwrap().then(r => {
                ...
                genresLoading
                    ...
                    genresError
                        ...
                        <div className="new-film">
                            <h2 className="text-center">{genreId ? "Edit Genre" : "Add Genre"}</h2>

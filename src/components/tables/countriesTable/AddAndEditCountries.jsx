...
import { getCountryById, newCountries, selectCountriesError, selectCountriesLoading, updateCountries } from "../../../features/countriesSlice";
...
export const AddAndEditCountries = () => {
    ...
    useEffect(() => {
        if (countryId) {
            dispatch(getCountryById(countryId)).unwrap().then(r => {
                ...
                countriesLoading
                    ...
                    countriesError
                        ...
                        <div className="new-film">
                            ...
                            <h2 className="text-center">{countryId ? "Edit Country" : "Add Country"}</h2>
